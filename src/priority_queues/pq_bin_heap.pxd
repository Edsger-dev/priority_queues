...
cdef void init_heap(BinaryHeap*, size_t) nogil
cdef void init_heap_para(BinaryHeap*, size_t, int) nogil
cdef void free_heap(BinaryHeap*) nogil
cdef void min_heap_insert(BinaryHeap*, size_t, DTYPE_t) nogil
cdef DTYPE_t peek(BinaryHeap*) nogil
cdef size_t extract_min(BinaryHeap*) nogil
cdef bint is_empty(BinaryHeap*) nogil
cdef void decrease_key_from_element_index(BinaryHeap*, size_t, DTYPE_t) nogil
cdef cnp.ndarray copy_keys_to_numpy(BinaryHeap*, size_t)
