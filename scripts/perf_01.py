...
elapsed_time = end - start
print(f"PQ Dijkstra bin basic - Elapsed time: {elapsed_time:6.2f} s")
...
elapsed_time = end - start
print(f"PQ Dijkstra  3-ary - Elapsed time: {elapsed_time:6.2f} s")
...
elapsed_time = end - start
print(f"PQ Dijkstra 4-ary - Elapsed time: {elapsed_time:6.2f} s")
